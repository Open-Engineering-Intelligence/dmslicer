...
def test_validator_rejects_tampered_translation_direction_and_norm() -> None:
    evidence = {
        ...
        "decision": {"executed_translation_mm": [0.0, 0.0, -0.05], "executed_translation_norm_mm": 0.05},
        "policy": {"allow_motion": True, "max_translation_mm": 0.1, "tauE_mm": 0.1},
        "post_measurement": {"measured_signed_offset_mm": 0.0},
        "contact_patch": {"dimension": "2D", "area_mm2": 10.0, "side_1_area_mm2": 10.0, "side_2_area_mm2": 10.0, "fused_boundary_overlap_area_mm2": 0.0},
        "fuse": {"executed": True, "solid_count": 1, "valid": True, "closed": True, "volume_conservation_error_mm3": 0.0},
        "invariants": {"input_step_hash_unchanged": True, "input_manifest_hash_match": True, "original_shapes_unchanged": True, "side_1_unchanged": True, "side_2_inverse_transform_match": True, "side_2_volume_unchanged": True, "rotation_is_identity": True, "scale_is_one": True},
        "reimport": {"corrected_assembly": {"role_binding": {"Side_1": "Side_1", "Side_2": "Side_2"}, "residual_offset_mm": 0.0, "contact_dimension": "2D", "contact_area_mm2": 10.0}, "fused": {"solid_count": 1, "valid": True, "closed": True}},
    }
